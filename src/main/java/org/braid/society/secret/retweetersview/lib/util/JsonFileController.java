 ...
 *
 * @author Ranfa
 * @apiNote each value will be wrapped into {@link Optional}. users must treat a case that value doesn't exist.
 * @since 1.0.0
 */
@Slf4j
public class JsonFileController {
     ...
     * @throws IOException If failed to read due to missing access permission, or that file does not exist, or so.
     */
